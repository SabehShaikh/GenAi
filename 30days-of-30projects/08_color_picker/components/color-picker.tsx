...
export function ColorPicker() {
  // to manage the currently selected color, initialized to black
  const [color, setColor] = useState<string>("#000000");

  // Event handler for updating the color state when the input value changes
  const handleChange = (e: ChangeEvent<HTMLInputElement>): void => {
    setColor(e.target.value);
  };

  // Function to copy the currently selected color to the clipboard
