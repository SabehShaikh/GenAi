...
/* if you want to make result of prompt a number, not string, 
use unary plus operator + before the prompt function call. 
// let age = +prompt('Your age?', 18); */
...
/* Functions may have local variables: those declared inside its body or 
its parameter list. Such variables are only visible inside the function.
