...
while (guestList.length > 2) {
    ...
    console.log("Sorry, ".concat(removedGuest, " we cannot invite you for dinner."));
}
for (var i = 0; i < guestList.length; i++) {
    console.log("Big guestList: ".concat(guestList[i], ", Would you still like to come for dinner tonight?"));
}
